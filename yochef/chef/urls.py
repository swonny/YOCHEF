...
urlpatterns = [
    ...
    path('chefSchedule/<int:book_id>', views.chefScheduleDetail, name="chefScheduleDetail"),
    path('chefSchedule/<int:book_id>/confirm', views.scheduleConfirm, name="scheduleConfirm"),
    path('chefSchedule/<int:book_id>/cancel', views.scheduleCancel, name="scheduleCancel"),
