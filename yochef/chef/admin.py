...
class ScheduleAdmin(admin.ModelAdmin):
    list_display = ['id', 'post', 'eventDate', 'eventTime', 'print_paymentStatus', 'print_confirmStatus']
    list_display_links = ['post', 'eventDate', 'eventTime', 'print_paymentStatus', 'print_confirmStatus']
    list_per_page = 20
