...
urlpatterns = [
	...
	path('paySuccess/<int:book_id>', paySuccess),
	...
	path('registerCancel/<int:book_id>', registerCancel, name="registerCancel"),
	path('checkDuplicate', checkDuplicateAPI, name="checkDuplicate"),
	path('writeReview', writeReviewAPI, name="writeReview"),
]